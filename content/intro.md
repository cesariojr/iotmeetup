...
4. Amadurecimento (ainda que lento) do IPv6 dando a possibilidade de um endereço único por dispositivo
...
7. Aumento do número de ferramentas Open Source para Big Data visando tratar o volume, variedade e velocidade de produção dos dados
